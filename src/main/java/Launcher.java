 ...
 */
import brew.BrewSpeechlet;
import hearst.HearstSpeechlet;
...
public final class Launcher {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        context.addServlet(new ServletHolder(createServlet(new HearstSpeechlet())), "/hearst");
        context.addServlet(new ServletHolder(createServlet(new BrewSpeechlet())), "/brew");
